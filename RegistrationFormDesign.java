...
class RegistrationFormDesign {
	...
	String name,dob1,dob2,dob,dobb,password,mobileNumber,email,area,state,address, nationality,selectedState;
	char gender;
	JComboBox combobox1;
	Connection con1;
	Statement st1;
...
public void registerUserData()
{
    ...
    // note that i'm leaving "date_created" out of this insert statement
			st.executeUpdate("INSERT INTO customer (phno, name, email, gender, dob, area, state, password ) VALUES("+num+",\'"+name+"\',\'"+email+"\',\'" +gender+"\',\'" + dobb + "\',\'"+ area +"\', \'" + state + "\' ,\'"+password+"\');");
			...
			Insertpage ip = new Insertpage(num);
			ip.runInsert(num);
		}
		catch (Exception e)
		{
